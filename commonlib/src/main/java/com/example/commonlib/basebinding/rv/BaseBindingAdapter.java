package com.example.commonlib.basebinding.rv;
...
import com.example.commonlib.BR;
...
public class BaseBindingAdapter<D, B extends ViewDataBinding> extends RecyclerView.Adapter<BaseBindingVH<B>> {
    private MutableLiveData<List> mLiveDatas = new MutableLiveData<>();
    ...
    public BaseBindingAdapter(Context mContext, int mLayoutId) {
        this.mContext = mContext;
        this.mLayoutId = mLayoutId;
        this.mInfalter = LayoutInflater.from(mContext);
    }
