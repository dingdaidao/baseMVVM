...
public class RxTransformer {
     ...
     * @return 返回Observable
     */
    public static <T> FlowableTransformer<T, T> transformFlow() {
        return upstream -> upstream
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .subscribeOn(AndroidSchedulers.mainThread())
   ...
   /* public static <T> ObservableTransformer<T, T> transform(final IBaseView view) {
     ...
     * @return
     */
 /*   public static <T> ObservableTransformer<T, T> transformWithLoading(final BaseViewModel view) {
        return observable -> observable.subscribeOn(Schedulers.io())
    ...
    public static <T> FlowableTransformer<T, T> transformFlowWithLoading(final BaseViewModel view) {
        return observable -> observable.subscribeOn(Schedulers.io())
                .doOnSubscribe(disposable -> {
                    view.showLoadingDialog();//显示进度条
                })
    ...
    /*public static <T> FlowableTransformer<T, T> transformFlow(final IBaseView view) {
        return observable -> observable.subscribeOn(Schedulers.io())
                .doOnSubscribe(disposable -> {
                })
                .observeOn(AndroidSchedulers.mainThread())
